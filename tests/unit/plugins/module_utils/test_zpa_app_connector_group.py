...
class TestAppConnectorGroupService(unittest.TestCase):
    def test_get_by_id_when_ok(self):
        ...
        rest.get.return_value.json = {"name": "bar", "id": "test", "connectors": [{
            "someField": "value"
        }]}
    ...
    def test_create_when_ok(self):
        jsonObj = {"name": "bar", "id": "test", "connectors": [{
            "someField": "value"
        }]}
        obj = {"name": "bar", "id": "test", "connectors": [{
            "some_field": "value"
        }]}
        module = MagicMock()
        rest = MagicMock()
    ...
    def test_create_when_nok(self):
        ...
        k = AppConnectorGroupService(module, "", rest)
        self.assertIsNone(k.create({"name": "bar", "id": "test", "connectors": [{
            "someField": "value"
        }]}))
    ...
    def test_update_when_nok(self):
        ...
        k = AppConnectorGroupService(module, "", rest)
        self.assertIsNone(k.update({"name": "bar", "id": "test", "connectors": [{
            "someField": "value"
        }]}))
