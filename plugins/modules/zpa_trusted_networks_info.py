...
from ansible_collections.willguibr.zpacloud.plugins.module_utils.zpa_trusted_networks import (
    TrustedNetworksService,
)
...
def core(module):
    ...
    if app_id is not None:
        ...
        if app is None:
            module.fail_json(msg="Failed to retrieve Trusted Network ID: '%s'" % (id))
        apps = [app]
