...
from ansible_collections.willguibr.zpacloud.plugins.module_utils.zpa_posture_profile import (
    PostureProfileService,
)
...
def core(module):
    ...
    if posture_id is not None:
        ...
        if posture is None:
            module.fail_json(msg="Failed to retrieve Posture Profile ID: '%s'" % (id))
        postures = [posture]
