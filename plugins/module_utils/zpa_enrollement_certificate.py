...
class EnrollementCertificateService:
    ...
    def getByID(self, id):
        response = self.rest.get(
            "/mgmtconfig/v1/admin/customers/%s/enrollmentCert/%s" % (self.customer_id, id))
    ...
    def getAll(self):
        list = self.rest.get_paginated_data(
            base_url="/mgmtconfig/v2/admin/customers/%s/enrollmentCert" % (self.customer_id), data_key_name="list")
        certificates = []
