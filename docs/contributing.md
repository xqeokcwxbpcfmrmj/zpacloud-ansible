...
Report bugs at https://github.com/willguibr/zpa-ansible/issues.
...
https://github.com/willguibr/zpa-ansible/issues.
...
Ready to contribute some code? Here's how to set up `zpa-ansible` for local development.
...
2. Fork the `zpa-ansible` repo on GitHub.
...
$ git clone https://github.com/your-username/zpa-ansible.git ansible_collections/willguibr/zpa
```
...
```
$ cd ansible_collections/willguibr/zpa
