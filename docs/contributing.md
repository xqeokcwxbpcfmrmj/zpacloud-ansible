...
Report bugs at https://github.com/willguibr/zpacloud-ansible/issues.
...
https://github.com/willguibr/zpacloud-ansible/issues.
...
$ git clone https://github.com/your-username/zpacloud-ansible.git ansible_collections/willguibr/zpacloud
```
...
4. Create a playbooks directory, and add our top level directory to `ansible.cfg`:
   ...
   `ansible_collections/willguibr/zpacloud` as the collection
...
```
$ cd ansible_collections/willguibr/zpacloud
