.. _zpa_browser_access_module:


zpa_browser_access - Create/Update/Delete a Browser Access Application Segment.
================================================================================
...
This module creates a Browser Access Application Segment in the ZPA Cloud.
...
.. code-block:: yaml+jinja
    ...
    - name: Browser Access Application Segment
      willguibr.zpacloud_ansible.zpa_browser_access:
        name: Example
        description: Example
        enabled: true
